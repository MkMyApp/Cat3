...
// Saveボタン状態
function setSaveEnabled(index, enabled) {
  if (saveButtons[index]) {
    saveButtons[index].disabled = !enabled;
  }
}
...
window.addEventListener("load", () => {
  setSaveEnabled(0, false);
  setSaveEnabled(1, false);
  setSaveEnabled(2, false);
